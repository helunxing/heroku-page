...
export const UPLOAD_EVENT_COUNT_DOWN = 'UPLOAD_EVENT_COUNT_DOWN'

export const INFO_POSTED = 'INFO_POSTED'
export const INFO_POSTED_COUNT_DOWN = 'INFO_POSTED_COUNT_DOWN'
